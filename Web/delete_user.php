...
<body>
  ...
  <div class="background-circle circle3"></div>
   <?php
    ...
    if (isset($_GET["delete_success"]) && $_GET["delete_success"] == "0") {
        echo '
        <div id="alert">
            <strong>Unsuccessful!</strong> Username is not available, try another Username.</div>';
    }
    ?>
